...
//sets the anchor point of the images, the size of the window, recall the object PImage with function to load the file.png and sets a value for the x, y coordinates of the images 
void setup() {
  imageMode(CENTER);
  size (600, 600);
